...
def fig1_profiles(df) -> None:
    ...
    ax1.set_title("图 1  单日电价、小区负载与光伏发电预测功率", fontsize=12)
...
def fig2_purchase(sol, df) -> None:
    ...
    ax.set_title("图 2  全天计划购电量与电价", fontsize=12)
...
def fig3_storage(sol) -> None:
    ...
    ax1.set_title("图 3  储能设备充放电功率与储电量", fontsize=12)
...
def fig4_balance(sol, df) -> None:
    ...
    ax.set_title("图 4  全天电量平衡", fontsize=12)
    ax.margins(x=0.35)
