...
OUT = Path(__file__).resolve().parents[1] / "08_算法修正" / "输出" / "p2_alpha_sensitivity.json"
...
def main() -> None:
    ...
    if args.core == "jia":
        ...
        cal_kw = {"min_samples": JIA_MIN_SAMPLES, "day0": "plan"}
        print("内核：jia（与主运行 --core=jia 一致）", flush=True)
    else:
